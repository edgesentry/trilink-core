...
For the open source vs. enterprise split — which components are published as MIT/Apache-2.0 and which are kept closed source, and why — see [strategy.md](strategy.md).
